...
const SignUp = () => {
	...
	return (
		<div className="absolute inset-0 h-[75%] flex flex-col justify-center items-center bg-white/20 text-white px-4 py-4 max-w-md m-auto rounded-lg">
			...
			<div className="text-center">
				...
				<p className="text-gray-300">Sign up to access smart, personalized travel plans made for you.</p>
			</div>
			...
			<button className="bg-blue-600 w-full hover:bg-blue-800 transition-all duration-200 text-white font-bold py-2 px-4 rounded-[19px]">SignUp</button>
